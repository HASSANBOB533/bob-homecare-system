...
const resources = {
  en: {
    translation: {
      ...
      "Manage availability, capacity, and block dates": "Manage availability, capacity, and block dates",
      ...
      "Block Date Range": "Block Date Range",
      "Start Date": "Start Date",
      "End Date": "End Date",
      "All time slots in this date range will be blocked from booking.": "All time slots in this date range will be blocked from booking.",
      "Blocking...": "Blocking...",
      "Capacity updated successfully": "Capacity updated successfully",
      "Slot availability updated": "Slot availability updated",
      ...
      "Capacity must be between 1 and 10": "Capacity must be between 1 and 10",
      "slots": "slots",
      "Previous": "Previous",
      "Next": "Next",
      "Sun": "Sun",
      ...
      "Fri": "Fri",
      "Sat": "Sat",
      "Available Times for": "Available Times for",
      "available": "available",
      "Full": "Full",
  ...
  ar: {
    translation: {
      ...
      // Slot Management
      "Time Slot Management": "إدارة الفترات الزمنية",
      "Manage availability, capacity, and block dates": "إدارة التوفر والسعة وحظر التواريخ",
      "Block Dates": "حظر التواريخ",
      "Select Date": "اختر التاريخ",
      "Loading slots...": "جاري تحميل الفترات...",
      "booked": "محجوز",
      "Available": "متاح",
      "Blocked": "محظور",
      "Capacity": "السعة",
      "Block": "حظر",
      "Unblock": "إلغاء الحظر",
      "No slots available for this date": "لا توجد فترات متاحة لهذا التاريخ",
      "Block Date Range": "حظر نطاق التواريخ",
      "Start Date": "تاريخ البداية",
      "End Date": "تاريخ النهاية",
      "All time slots in this date range will be blocked from booking.": "سيتم حظر جميع الفترات الزمنية في هذا النطاق من الحجز.",
      "Blocking...": "جاري الحظر...",
      "Capacity updated successfully": "تم تحديث السعة بنجاح",
      "Slot availability updated": "تم تحديث توفر الفترة",
      ...
      "Start date must be before end date": "يجب أن يكون تاريخ البداية قبل تاريخ النهاية",
      "Capacity must be between 1 and 10": "يجب أن تكون السعة بين 1 و 10",
      "slots": "فترات",
      "Previous": "السابق",
      "Next": "التالي",
      "Sun": "الأحد",
      ...
      "Fri": "الجمعة",
      "Sat": "السبت",
      "Available Times for": "الأوقات المتاحة لـ",
      "available": "متاح",
      "Full": "ممتلئ",
